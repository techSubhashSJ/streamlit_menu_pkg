...
def st_menu(menu_items={}, header={}, divider_between_header_and_body=True, header_style={}, wrapper_style={}, submenu_style={}, single_menu_style={}, is_collapsible=False, on_change=None, args=None):
    with st.sidebar:
